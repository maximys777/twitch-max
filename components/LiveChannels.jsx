...
const LiveChannels = () => {
  return (
    <div id='live' className='p-2 md:p-8'>
        ...
        <LiveChannelItem
          img={Live1}
          profile_img='https://static-cdn.jtvnw.net/jtv_user_pictures/2cce9404-2a3d-493a-969b-66608004dbff-profile_image-50x50.png'
        ...
        <LiveChannelItem
          img={Live2}
          profile_img='https://static-cdn.jtvnw.net/jtv_user_pictures/4c6aa1e0-ffff-4fd8-af20-d08dd94e0acd-profile_image-50x50.png'
